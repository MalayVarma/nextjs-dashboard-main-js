...
const Pokemons = (props) => {
  ...
  const { data: { data: resource } } = useSWRAxios({
    ...
    transformResponse: transformResponseWrapper((d, h) => {
...
export const getServerSideProps = async (context) => {
  ...
  const { data: pokemons, headers } = await axios.get(pokemonListURL, {
    params: {
      _page: page,
      _limit: perPage,
      _sort: sort,
  ...
  const pokemonResource = newResource(pokemons, total, page, perPage)
